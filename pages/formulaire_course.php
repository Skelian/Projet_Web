...
<div id="contenue">
    <h1>Courses</h1>
	<br />
	<p>Liste de courses de <?php echo $nom?> <?php echo $prenom?></p><!-- Nom/prénom de l'utilisateur qui est co-->
	
	<!-- Pour chaque produit que l'on veut ajouter, il faut renseigner le nom, la quantité et le prix/u, le prix du lot sera alors calculé -->
	...
	<p>
		<form method="post" action="course.php">
			<button type="submit" name="btnAjouterCourse">Ajouter la liste</button> 
		</form>
	</p>
