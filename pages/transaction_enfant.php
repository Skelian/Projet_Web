...
<div id="contenue">
    <h1>Enfants</h1>
	<br />
	<p>Transaction(s) faite(s) par <?php echo $nom?> <?php echo $prenom?></p><!-- Nom/prénom du compte enfant qui a fait la transaction -->
	
	<!-- Pour chaque transaction, il faut voir le le numéro, la date, l'heure et le montant -->
